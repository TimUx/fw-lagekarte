...
## Einfacher WebSocket-Server (Beispiel-Implementation)

Hier ist eine einfache Beispiel-Implementierung eines Synchronisations-Servers:
...
3. Aktivieren Sie "Synchronisation aktivieren"
